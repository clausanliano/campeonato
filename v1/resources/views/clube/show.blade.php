    ...
    <div class="card-header">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <input disabled class="form-control @error('nome') is-invalid @enderror"
            ...
            <div class="form-group">
                ...
                <textarea disabled class="form-control @error('endereco') is-invalid @enderror"
            ...
            <div class="form-group">
                ...
                <input disabled class="form-control @error('telefone') is-invalid @enderror"
            ...
            <div class="form-group">
                ...
                <input disabled class="form-control @error('site') is-invalid @enderror"
            ...
            <div class="form-group">
                ...
                <input disabled class="form-control @error('instagram') is-invalid @enderror"
            ...
            <div class="form-group">
                ...
                <input disabled class="form-control @error('twitter') is-invalid @enderror"
